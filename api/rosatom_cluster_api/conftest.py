...
from rosatom_cluster_api.services.rabbit.lifetime import init_rabbit, shutdown_rabbit
from rosatom_cluster_api.services.redis.dependency import get_redis_pool
from rosatom_cluster_api.web.application import get_app
from rosatom_cluster_api.db.dependencies import get_db_session
from rosatom_cluster_api.db.utils import create_database, drop_database
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    :yield: new engine.
    """
    from rosatom_cluster_api.db.meta import meta  # noqa: WPS433
    from rosatom_cluster_api.db.models import load_all_models  # noqa: WPS433
